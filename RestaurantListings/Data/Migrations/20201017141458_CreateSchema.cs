        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsersRated = table.Column<string>(nullable: true, defaultValue: "[]")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Restaurants",
                columns: new[] { "Id", "Address", "Description", "FamilyFriendly", "Name", "PhoneNumber", "PhotoUri", "Rating", "Tags", "UsersRated", "VeganFriendly" },
